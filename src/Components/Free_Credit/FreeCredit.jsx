...
<img src="../../../Public/assets/bg-shadow.png" className=' w-full h-full rounded-xl absolute pointer-events-none' alt="" />

<div className='text-white flex flex-col items-center  gap-5 '>


    <img src="../../../Public/assets/banner-main.png" className='w-52 min-h-44' alt="" />
